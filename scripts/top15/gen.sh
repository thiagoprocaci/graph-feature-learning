...
python2 "$FEATURE_LEARNING_NODE_2_VEC"  --input="$EDGE_LIST_BIOLOGY" --output="$OUTPUT_BFS_EMD" --dimensions="$DIM" --executionType=smt --num-walks=1
...
python2 "$FEATURE_LEARNING_NODE_2_VEC"  --input="$EDGE_LIST_CHEMISTRY" --output="$OUTPUT_BFS_EMD" --dimensions="$DIM" --executionType=smt --num-walks=1
