...
Rscript biology-ml.R "$OUTPUT_NODE_2_VEC_Q_GRT_P_AUC" "$OUTPUT_NODE_2_VEC_Q_GRT_P_EMD" "$BIOLOGY_CLASS_FILE"
Rscript biology-ml.R "$OUTPUT_NODE_2_VEC_Q_LST_P_AUC" "$OUTPUT_NODE_2_VEC_Q_LST_P_EMD" "$BIOLOGY_CLASS_FILE"
Rscript biology-ml.R "$OUTPUT_NODE_2_VEC_Q_EQ_P_AUC" "$OUTPUT_NODE_2_VEC_Q_EQ_P_EMD" "$BIOLOGY_CLASS_FILE"
Rscript biology-ml.R "$OUTPUT_BFS_AUC" "$OUTPUT_BFS_EMD" "$BIOLOGY_CLASS_FILE"
Rscript biology-ml.R "$OUTPUT_LINE_2_AUC" "$OUTPUT_LINE_2_EMD" "$BIOLOGY_CLASS_FILE"
Rscript biology-ml.R "$OUTPUT_LINE_1_AUC" "$OUTPUT_LINE_1_EMD" "$BIOLOGY_CLASS_FILE"
...
Rscript biology-ml.R "$OUTPUT_NODE_2_VEC_Q_GRT_P_AUC" "$OUTPUT_NODE_2_VEC_Q_GRT_P_EMD" "$CHEMISTRY_CLASS_FILE"
Rscript biology-ml.R "$OUTPUT_NODE_2_VEC_Q_LST_P_AUC" "$OUTPUT_NODE_2_VEC_Q_LST_P_EMD" "$CHEMISTRY_CLASS_FILE"
Rscript biology-ml.R "$OUTPUT_NODE_2_VEC_Q_EQ_P_AUC" "$OUTPUT_NODE_2_VEC_Q_EQ_P_EMD" "$CHEMISTRY_CLASS_FILE"
Rscript biology-ml.R "$OUTPUT_BFS_AUC" "$OUTPUT_BFS_EMD" "$CHEMISTRY_CLASS_FILE"
Rscript biology-ml.R "$OUTPUT_LINE_2_AUC" "$OUTPUT_LINE_2_EMD" "$CHEMISTRY_CLASS_FILE"
Rscript biology-ml.R "$OUTPUT_LINE_1_AUC" "$OUTPUT_LINE_1_EMD" "$CHEMISTRY_CLASS_FILE"
